function onCreate()
	makeLuaSprite('main', 'impostor/MainBG', -600, -300);
	setScrollFactor('main', 1, 1);
	
	makeLuaSprite('red', 'impostor/red', -1000, -500);
	setScrollFactor('red', 1, 1);
	scaleObject('red', 5, 5);
	
	makeLuaSprite('red1', 'impostor/red1', -1000, -500);
	setScrollFactor('red1', 1, 1);
	scaleObject('red1', 5, 5);
	
	makeLuaSprite('red2', 'impostor/red2', -1000, -500);
